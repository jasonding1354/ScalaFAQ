# ScalaFAQ
---
本项目是根据《Programming Scala》、《Scala Cookbook》等书的学习示例进行的提炼总结，还包含了很多Scala的基本知识点和技术细节。
希望通过该项目的总结能够及时总结Scala编程遇到的常见问题和解决方法，对Scala语法和应用有更加深入的理解。
感谢jupyter-scala项目让我可以在jupyter notebook上编写Scala小程序，并进行交互式的总结。
...
- [基本知识点2](https://github.com/jasonding1354/ScalaFAQ/blob/master/basics/basics2.ipynb)
